...
export const JobDetailsBriefCard = () => {
	...
	return (
		<Card className="grow border-none">
			...
			<ApplyToJob.Provider
				handleDialogChange={(applyDialogOpen) => {
					if (applyDialogOpen) {
						setOpen(false);
					}

					return applyDialogOpen;
				}}>
						...
						<DialogHeader className="p-4 space-y-[1.125rem] border-b border-b-divider-dark">
							<div className="flex justify-between items-center gap-x-4 w-full">
								<div className="flex items-center gap-x-3">
									...
									<DialogTitle>
										<span className="block text-placeholder text-sm">
											WorkOS
										</span>
								...
								<div className="pr-3">
									<ApplyToJob.Trigger>
										<Button className="rounded-10">Easy Apply</Button>
									</ApplyToJob.Trigger>
								</div>
							</div>
						...
						<DialogDescription className="p-4 space-y-4">
							...
							<div className="space-y-3 text-[1.0625rem]">
								...
								<p>
									...
									you&apos;ll work across a wide range of digital experiences
									with the view to refine and extend our established on-line
									presence.
								</p>
							</div>
						</DialogDescription>
